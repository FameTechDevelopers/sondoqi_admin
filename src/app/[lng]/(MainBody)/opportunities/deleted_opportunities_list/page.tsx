...
const DeletedOpportunityList = () => {
  ...
  const handleActive = async (id: string) => {
    try {
      const response = await axios.get(`${BASE_URL}/package/activePackage`, {
        params: {
          package_id: id,
          user_id: user?._id,
        },
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        `${BASE_URL}/package/getDeletedPackages`,
        {
          params: {
            // page,
          },
      ...
      cell: (row) => {
        return (
          <ul
            ...
            key={row?._id}
          >
            <li className="edit" title="Approve">
              <button
...
export default DeletedOpportunityList;
